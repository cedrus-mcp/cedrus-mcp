...
def instructions_sketch(app_ctx: AppContext) -> str:
    instructions = (
        ...
        f'{NextAction(tool="add", params={"label": "Claim Label", "proposition": "The proposition maintained by this claim."}, reason="Add a new claim.", action_type="expand").model_dump()}\n'
        f'{NextAction(tool="add", params={"label": "Argument Label", "gist": "The main idea of this argument."}, reason="Add a new argument.", action_type="expand").model_dump()}\n'
        f'{NextAction(tool="connect", params={"from_label": "Argument Label", "to_label": "Claim Label", "relation": "support"}, reason="Connect an argument to a claim with a support relation.", action_type="expand").model_dump()}\n'
        "\n"
    )
...
def instruction_author(app_ctx: AppContext) -> str:
    instructions = (
        ...
        f'{NextAction(tool="edit", params={"label": "Claim Label", "proposition": "The revised and clarified proposition of this claim."}, reason="Edit an existing claim to add more detail.", action_type="refine").model_dump()}\n'
        f'{NextAction(tool="edit", params={"label": "Argument Label", "conclusion": "The proposition serving as the conclusion of this argument."}, reason="Edit an existing argument to add more detail.", action_type="refine").model_dump()}\n'
        f'{NextAction(tool="connect", params={"from_label": "Argument 1", "to_label": "Argument 2", "relation": "attack", "target_premise_idx": "2"}, reason="Ground attack relation by specifying that the conclusion of <Argument 1> negates premise (2) of <Argument 2>.", action_type="refine").model_dump()}\n'
        "\n"
    )

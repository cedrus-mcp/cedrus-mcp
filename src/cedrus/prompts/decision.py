...
def deliberate_decision(decision_problem: str) -> str:
    ...
    return (
        ...
        "### Phase IV: Reviewing and consolidating (`review` and `elaborate` modes)\n\n"
        ...
        "- Revise the reasoning graph until it passes all validation checks and meets your own standards of clarity and "
        "completeness (iterating between `review` and `elaborate` mode).\n\n"
        ...
        "- If available, use todo lists to dynamically track, add, and manage specific tasks and subtasks during your "
        "deliberation.\n"

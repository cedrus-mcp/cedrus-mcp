...
from cedrus.tools.tools import inspect_graph, add_claim_sketch, add_argument_sketch
...
async def test_inspect_graph_invalid_format(tool_context: Mock) -> None:
    ...
    result = await inspect_graph(ctx=tool_context, format="invalid")  # type: ignore

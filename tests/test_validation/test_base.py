...
def test_validate_empty_map_elaborate_mode(
...
def test_validate_simple_claim_sketch_mode(
    simple_claim_map: ArgumentMap, sketch_context: ToolContext
) -> None:
...
def test_validate_simple_claim_elaborate_mode(
    simple_claim_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_validate_returns_issue_count(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_validate_with_fix_parameter(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_validate_with_max_issues_parameter(
    simple_claim_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_validate_mode_specific_checks_sketch(
    empty_map: ArgumentMap, sketch_context: ToolContext
) -> None:
...
def test_validate_mode_specific_checks_elaborate(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:

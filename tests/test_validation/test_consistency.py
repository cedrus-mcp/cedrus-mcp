...
def test_check_consistency_single_proposition(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_consistency_equivalent_propositions_no_contradiction(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_consistency_detects_self_contradictory_equivalence_class(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_consistency_independent_propositions(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_consistency_contradictory_but_not_equivalent(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:

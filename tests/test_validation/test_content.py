...
def add_claim_node(arg_map: ArgumentMap, content: str) -> str:
    ...
    claim_count = sum(
        1
        for n in arg_map.argument_graph.nodes()
        if arg_map.argument_graph.nodes[n].get("_type") == "claim"
    )
...
def add_argument_node(arg_map: ArgumentMap, gist: str) -> str:
    ...
    arg_count = sum(
        1
        for n in arg_map.argument_graph.nodes()
        if arg_map.argument_graph.nodes[n].get("_type") == "argument"
    )
...
def test_check_core_content_empty_map(
...
def test_check_core_content_claim_with_proposition(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_claim_missing_proposition(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_claim_whitespace_only_proposition(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_argument_with_gist(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_argument_missing_gist(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_argument_whitespace_only_gist(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_respects_max_issues(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_core_content_generates_suggestions_in_sketch_mode(
    empty_map: ArgumentMap, sketch_context: ToolContext
) -> None:
...
def test_check_core_content_generates_edit_suggestions(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_empty_map(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_claim_node_no_check(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_valid_argument(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_missing_conclusion(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_missing_premises(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_missing_both(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_respects_max_issues(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
    """Test that max_issues parameter limits reported issues."""
...
def test_check_argument_structure_generates_mode_switch_suggestions_in_sketch(
    empty_map: ArgumentMap, sketch_context: ToolContext
) -> None:
    """Test that suggestions include mode switch in sketch mode."""
    arg = ArgumentNode(label="A1", gist="Incomplete", premises=[], conclusion="")
...
def test_check_argument_structure_generates_edit_suggestions(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
    """Test that suggestions include edit tool suggestions."""
    arg = ArgumentNode(label="A1", gist="Incomplete", premises=[], conclusion="")
...
def test_check_argument_structure_single_premise_valid(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_argument_structure_multiple_premises_valid(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:

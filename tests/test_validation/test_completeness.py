...
def test_check_completeness_single_node(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_completeness_respects_max_issues(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_completeness_skips_self_relations(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:
...
def test_check_completeness_all_pairs_checked(empty_map: ArgumentMap, elaborate_context: ToolContext) -> None:

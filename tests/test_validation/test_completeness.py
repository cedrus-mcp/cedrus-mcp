...
def test_check_completeness_empty_map(empty_map: ArgumentMap, author_context: ToolContext) -> None:
    """Test completeness check on empty map."""
    issues = check_completeness(empty_map, author_context)
    assert issues == 0


def test_check_completeness_single_node(empty_map: ArgumentMap, author_context: ToolContext) -> None:
...
def test_check_completeness_respects_max_issues(empty_map: ArgumentMap, author_context: ToolContext) -> None:
    ...
    issues = check_completeness(empty_map, author_context, max_issues=2)
    
    assert issues <= 2


def test_check_completeness_skips_self_relations(empty_map: ArgumentMap, author_context: ToolContext) -> None:
...
def test_check_completeness_all_pairs_checked(empty_map: ArgumentMap, author_context: ToolContext) -> None:

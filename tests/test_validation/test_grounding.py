...
def test_check_grounding_no_relations(
...
def test_check_grounding_properly_grounded_support(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
    ...
    if arg_node and claim_node:
        ...
        empty_map.update_node(
            arg_label,
            {
                "conclusion": arg_node.conclusion,
                "premises": arg_node.premises,
                "gist": arg_node.gist,
            },
        )
...
def test_check_grounding_ungrounded_support_relation(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_properly_grounded_attack(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_ungrounded_attack_relation(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_respects_max_issues(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_generates_error_level_issues(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_generates_suggestions(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_checks_all_support_relations(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_checks_all_attack_relations(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_mixed_relation_types(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_fix_parameter_has_no_effect(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
...
def test_check_grounding_target_premise_grounding(
    empty_map: ArgumentMap, elaborate_context: ToolContext
) -> None:
